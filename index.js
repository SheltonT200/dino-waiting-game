...
(function () {
    ...
    function Runner(outerContainerId, opt_config) {
        // Singleton
        if (Runner.instance_) {
		//setTimeout('cx+=0.05;z=z+0.000003;c=(((c+1)*1.5)-1)/cx;Runner().distanceMeter.config.COEFFICIENT=z/(55*c)',2500)
    ...
    Runner.config = {
        ...
        GAP_COEFFICIENT: 0.01,
        GRAVITY: 0.001,
        INITIAL_JUMP_VELOCITY: 120,
        INVERT_FADE_DURATION: 100,
        INVERT_DISTANCE: 700,
        MAX_BLINK_COUNT: 300,
        MAX_CLOUDS: 600,
    ...
    Trex.config = {
        ...
        INTRO_DURATION: 1500,//1500,
        MAX_JUMP_HEIGHT: 300,
        MIN_JUMP_HEIGHT: 30,
        SPEED_DROP_COEFFICIENT: 0.5,
        SPRITE_WIDTH: 262,
        START_X_POS: 50,
        WIDTH: 44,
        WIDTH_DUCK: 59
    ...
    Trex.collisionBoxes = {
        DUCKING: [
            new CollisionBox(-100, -100, -100, -100)
        ],
        RUNNING: [
            new CollisionBox(-100, -100, -100, -100)/*,
            new CollisionBox(0, 0, 0, 0),
            new CollisionBox(0, 0, 0, 0),
            new CollisionBox(0, 0, 0, 0),
            new CollisionBox(0, 0, 0, 0),
            new CollisionBox(0, 0, 0, 0)*/
